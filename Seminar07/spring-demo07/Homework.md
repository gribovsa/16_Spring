...
~~~
    ...
    1.4* /ui/readers/{id} - страница, где написано имя читателя с идентификатором id и перечислены книги,  
...
~~~
    ...
    По дефолту открываем swagger на странице: http://localhost:8080/swagger-ui/index.html
